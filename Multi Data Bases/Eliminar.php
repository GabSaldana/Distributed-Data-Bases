...
<html>
    ...
    <body>
        ...
        <?php
            ...
            delete_Proveedor_tienda($conn,$idProveedor,$Direccion,$Telefono);
            ...
            // Realizar una consulta MySQL
            delete_Proveedor_oxxo($conn,$idProveedor,$Calle,$Numero, $Colonia, $Telefono);
            ...
            // Realizar una consulta MySQL
            delete_Proveedor_fp($conn,$idProveedor,$Direccion, $Telefono);
        ?>
